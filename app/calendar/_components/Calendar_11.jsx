...
const RadialCircularCalendar = ({ initialDate, onSelectDate }) => {
  ...
  return (
    <div className="relative w-96 h-96 mx-auto rounded-full bg-gradient-to-tl from-orange-500 via-red-500 to-yellow-500 flex items-center justify-center overflow-hidden">
              ...
              className={`w-12 h-12 flex items-center justify-center text-base font-medium rounded-full transition-transform duration-300
                ...
                ${
                  selectedDate?.toDateString() === date.toDateString()
                    ? "bg-gradient-to-br from-yellow-400 to-red-500 text-white ring-4 ring-gray-800"
                    : "hover:bg-gray-400"
                }`}
            >
              {date.getDate()}
