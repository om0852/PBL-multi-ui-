...
const AnimatedCalendar = ({ initialDate, onSelectDate }) => {
  ...
  return (
    <div className="w-96 mx-auto bg-gray-50 rounded-xl shadow-lg p-6">
      {/* Header */}
      <motion.div
      ...
      >
        <button
          ...
          className="px-4 py-2 bg-blue-300 text-blue-900 rounded-lg hover:bg-blue-400"
        >
          &lt;
        </button>
      ...
      {selectedDate && (
        <motion.div
          className="mt-6 text-center text-xl font-bold text-blue-600"
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
          transition={{ duration: 0.5 }}
        >
