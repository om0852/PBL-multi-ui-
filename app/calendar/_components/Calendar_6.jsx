...
const Calendar = ({ initialDate, onSelectDate }) => {
  ...
  return (
    <div className="flex bg-white shadow-lg rounded-lg w-[700px] h-[400px] font-roboto">
      <div className="flex flex-col justify-center items-center bg-pink-500 text-white w-1/3 shadow-md p-4">
        <div className="text-lg font-medium uppercase">
          {currentDate.toLocaleString("default", { month: "long" })}
        </div>
        <div className="text-8xl font-light">{selectedDate?.getDate()}</div>
      </div>

      <div className="flex-grow flex flex-col bg-white p-4 w-2/3">
